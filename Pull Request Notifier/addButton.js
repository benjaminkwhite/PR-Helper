    ...
    function addButton(){
        ...
        var doAddButton = function() {
            ...
            if (user_links) {
                ...
                <a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">You<svg aria-hidden="true" class="octicon octicon-star" height="16" version="1.1" viewBox="0 0 14 16" width="14" id="prStart" style="color: red; float: right;"><path d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"></path></svg></a>\
                <a class="dropdown-item" id="prAdd" href="/new/import" data-ga-click="Header, import a repository">add</a>\
                <a class="dropdown-item" id="prRemove" href="/organizations/new" data-ga-click="Header, create new organization">remove</a></div>\
                </div></li>';
