    ...
    var doAddButton = function() {
      ...
      if (user_links) {
        button_embed = '<li class="header-nav-item dropdown js-menu-container">\
                ...
                <a class="dropdown-item" id="prYou" href="javascript:void(0)" data-ga-click="Header">This is me!<svg aria-hidden="true" class="octicon octicon-star" height="16" version="1.1" viewBox="0 0 14 16" width="14" id="prStart" style="color: red; float: right;"><path d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"></path></svg></a>\
                <a class="dropdown-item" id="prAdd" href="javascript:void(0)" data-ga-click="Header">Add teammate</a>\
                <a class="dropdown-item" id="prRemove" href="javascript:void(0)" data-ga-click="Header">Remove teammate</a></div>\
                </div></li>';
